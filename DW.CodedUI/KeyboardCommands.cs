...
{
    /// <summary>
    /// Represents keys to be send with the <see cref="Microsoft.VisualStudio.TestTools.UITesting.Keyboard" /> or <see cref="DW.CodedUI.KeyboardEx" />.
    /// </summary>
    public static class KeyboardCommands
    {
        ...
        /// The print key.
        /// </summary>
        public const string Print = "{PRTSC}";
